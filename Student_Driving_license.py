...
label_heading =Label()
label_id_tag =Label()
label_name_label_dob_tag =Label()
label_pin_tag =label_address_tag =Label()
label_vehicle_type_tag =Label()


def gui():
    label_heading["text"]
    label_id_tag["text"]
    label_name_label_dob_tag["text"]
    label_pin_tag =label_address_tag["text"]
    label_vehicle_type_tag["text"]


button1 =Button(root,text="show",command=gui)
